...
DEFINE_SIMPLE_MSG(MsgToPe_PrlReportError, MSG_TO_PE__PRL_REPORT_ERROR);
...
//
enum msg_prl_id {
    MSG_TO_PRL__ENQUEUE_INIT = 120,
    MSG_TO_PRL__ENQUEUE_PRL_SOFT_RESET,
...
DEFINE_SIMPLE_MSG(MsgToPrl_EnqueueInit, MSG_TO_PRL__ENQUEUE_INIT);
DEFINE_SIMPLE_MSG(MsgToPrl_EnqueuePrlSoftReset, MSG_TO_PRL__ENQUEUE_PRL_SOFT_RESET);
